...
process_num=4
gpu_count=2
epoches_per_launch=10000   # this is the number of epoch run in each iteration, change this and the step 
launches=9999

python_script='cifar_WLMD.py'  # edits as needed for the training code
