...
process_num=20
gpu_count=4
epoches_per_launch=500000   # this is the number of epoch run in each iteration, change this and the step 
launches=4

python_script='Kaggle_house_GPU_Training_Parallelized.py'  # edits as needed for the training code
